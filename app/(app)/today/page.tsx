...
function buildImplicationLine(
  ...
  // Tags are independent qualitative flags (see inferTagsFromNotes in checkin-utils.ts),
  // not derived from feelScore — a high feelScore does not clear them.
              ...
              {props.length === 0 ? (
                <StaggerList className="space-y-3">
                  ...
                  <StaggerItem className="lg:hidden">
                    <NutritionCard initialAdvice={nutritionAdvice} scopeKey={todayStr} />
                  </StaggerItem>
                  <StaggerItem>
