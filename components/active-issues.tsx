...
export function ActiveIssues({ initialIssues }: { initialIssues: IssueItem[] }) {
  ...
  return (
    <div className="rounded-2xl border-l-[3px] border-l-orange-400 border border-orange-100 bg-orange-50 px-4 py-3 space-y-2.5">
        ...
        return (
          <div key={issue.checkInId} className="flex items-start justify-between gap-3">
            <div className="min-w-0">
              <p className="text-xs font-semibold text-orange-900">{label}</p>
            ...
            <button
              ...
              className="shrink-0 text-xs font-medium text-emerald-700 underline disabled:opacity-40 hover:text-emerald-800 transition-colors"
            >
              Resolve
            </button>
          </div>
